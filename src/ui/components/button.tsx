  ...
  disabled:tl-pointer-events-none disabled:tl-opacity-50 tl-select-none`,
  {
    variants: {
      variant: {
        ...
        opposite: 'tl-bg-foreground tl-text-secondary tl-shadow hover:tl-bg-foreground/90',
        destructive:
        ...
        ghost: 'tl-text-text hover:tl-bg-foreground/10 hover:tl-text-accent-foreground',
